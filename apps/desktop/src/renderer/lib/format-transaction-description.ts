...
type StripResult = { base: string; hadSuffix: boolean }
...
/**
 * Renders a transaction description for the UI: English "(projected)" in the DB
 * is shown with a localized parenthetical (e.g. "esperado" in pt).
 */
